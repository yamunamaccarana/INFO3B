...
//			break;
		case 2:
			...
			System.out.println("Enviroment: Test Luggage 1: "+t2.toString()+" at "+new Timestamp(date.getTime())+" ");
			try {
				send(ETopic, t2);
			} catch (TopicNotFoundException e) {e.printStackTrace();}
			it++;
		...
		case 3:
			...
			System.out.println("Enviroment: Test Luggage 2: "+t3.toString()+" at "+new Timestamp(date.getTime())+" ");
			try {
				send(ETopic, t3);
			} catch (TopicNotFoundException e) {e.printStackTrace();}
			it++;
		...
		case 4:
			...
			System.out.println("Enviroment: Test Luggage 3: "+t4.toString()+" at "+new Timestamp(date.getTime())+" ");
			try {
				send(ETopic, t4);
			} catch (TopicNotFoundException e) {e.printStackTrace();}
			it++;
